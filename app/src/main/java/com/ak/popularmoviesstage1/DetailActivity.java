...
public class DetailActivity extends AppCompatActivity {
    ...
    String api_key = "83e92d22b153e429f4401c1e9dafcc1f";
    //my tmdb api key
    ...
    public class FetchMovieDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                poster_path = "https://image.tmdb.org/t/p/w185" + main.getString("poster_path");
        ...
        protected void onPostExecute(Void result) {
            ...
            poster_image.setPadding(16, 16, 16, 16);
